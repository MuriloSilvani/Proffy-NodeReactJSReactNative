...
function TeacherForm(){
    ...
    function setScheduledItemValue(index:number, field: string, value: string) {
        const updatedScheduledItems = scheduledItems.map((item, position) => {
            if(index === position) {
                return {
                    ...item,
                    [field]: value
                ...
                <form onSubmit={handleCreateClass}>
                    ...
                    <fieldset>
                        <legend>
                            ...
                            <button onClick={addNewScheduled} type='button'>
                                + Novo hoŕarios
                            </button>
                        </legend>

                    {
                        scheduledItems.map((scheduledItem, index) => {
                            return (
                                <div key={scheduledItem.week_day} className="scheduled-item">
                                    <Select
                                        name='week_day'
                                        label='Dia da seman'
                                        onChange={event => setScheduledItemValue(index, 'week_day', event.target.value)}
                                        options={[
                                    ...
                                    <Input
                                        ...
                                        label='Das'
                                        type='time'
                                        onChange={event => setScheduledItemValue(index, 'from', event.target.value)}
                                    />
                                    <Input
                                        name='to'
                                        label='Até'
                                        type='time'
                                        onChange={event => setScheduledItemValue(index, 'to', event.target.value)}
                                    />
                                </div>
                            )
                        })
